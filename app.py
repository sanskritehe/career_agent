...
with st.sidebar:
    ...
    if page == "Resume & Job Match":
        st.info("💼 Resume Analysis & Job Matching\n\nAnalyze your resume and find suitable roles based on your skills.")
    else:
        st.info("🎯 DSA Tutor\n\nPersonalized Data Structures & Algorithms learning path with practice problems and progress tracking.")
