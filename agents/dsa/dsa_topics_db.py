# DSA Topics Database — NeetCode-inspired
...
DSA_TOPICS_MAP = {
    "Arrays & Hashing": {
        ...
        "problems": [
            ...
            {"id": "128", "name": "Longest Consecutive Sequence",  "difficulty": "Medium", "time_estimate_mins": 35, "leetcode_link": "https://leetcode.com/problems/longest-consecutive-sequence/",               "tags": ["Hash Set", "Array"]},
        ],
    },
    "Two Pointers": {
    ...
    "Sliding Window": {
        "description": "Optimise array and string problems using sliding window",
        "estimated_weeks": 2,
        "problems": [
            ...
            {"id": "424", "name": "Longest Repeating Character Replacement",           "difficulty": "Medium", "time_estimate_mins": 30, "leetcode_link": "https://leetcode.com/problems/longest-repeating-character-replacement/",          "tags": ["Sliding Window", "Hash Map"]},
    ...
    "Stack": {
        ...
        "problems": [
            ...
            {"id": "84",  "name": "Largest Rectangle in Histogram",         "difficulty": "Hard",   "time_estimate_mins": 45, "leetcode_link": "https://leetcode.com/problems/largest-rectangle-in-histogram/",             "tags": ["Stack", "Array"]},
        ],
    },
    "Linked List": {
    ...
    "Binary Search": {
        ...
        "problems": [
            ...
            {"id": "981", "name": "Time Based Key-Value Store",                 "difficulty": "Medium", "time_estimate_mins": 30, "leetcode_link": "https://leetcode.com/problems/time-based-key-value-store/",                  "tags": ["Binary Search", "Design"]},
    ...
    "Graphs": {
        ...
        "problems": [
            ...
            {"id": "323", "name": "Number of Connected Components", "difficulty": "Medium", "time_estimate_mins": 25, "leetcode_link": "https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/", "tags": ["Graph", "Union Find"]},
    ...
    "Heap": {
        ...
        "problems": [
            ...
            {"id": "215",  "name": "Kth Largest Element in an Array",    "difficulty": "Medium", "time_estimate_mins": 25, "leetcode_link": "https://leetcode.com/problems/kth-largest-element-in-an-array/",   "tags": ["Heap", "Sorting"]},
    ...
    "Dynamic Programming": {
        ...
        "problems": [
            ...
            {"id": "746",  "name": "Min Cost Climbing Stairs",           "difficulty": "Easy",   "time_estimate_mins": 15, "leetcode_link": "https://leetcode.com/problems/min-cost-climbing-stairs/",          "tags": ["DP"]},
    ...
    "Greedy": {
        ...
        "problems": [
            ...
            {"id": "45",  "name": "Jump Game II",                       "difficulty": "Medium", "time_estimate_mins": 25, "leetcode_link": "https://leetcode.com/problems/jump-game-ii/",                       "tags": ["Greedy", "Array"]},
        ],
    },
    "Intervals": {
    ...
    "Math & Geometry": {
        ...
        "problems": [
            ...
            {"id": "54",  "name": "Spiral Matrix",      "difficulty": "Medium", "time_estimate_mins": 25, "leetcode_link": "https://leetcode.com/problems/spiral-matrix/",     "tags": ["Math", "Matrix"]},
        ],
    },
    "Strings": {
        ...
        "problems": [
            ...
            {"id": "5",   "name": "Longest Palindromic Substring",  "difficulty": "Medium", "time_estimate_mins": 30, "leetcode_link": "https://leetcode.com/problems/longest-palindromic-substring/",  "tags": ["String", "DP"]},
            {"id": "438", "name": "Find All Anagrams in a String",  "difficulty": "Medium", "time_estimate_mins": 25, "leetcode_link": "https://leetcode.com/problems/find-all-anagrams-in-a-string/",  "tags": ["String", "Sliding Window"]},
    ...
    "Backtracking": {
        ...
        "problems": [
            ...
            {"id": "79",  "name": "Word Search",        "difficulty": "Medium", "time_estimate_mins": 35, "leetcode_link": "https://leetcode.com/problems/word-search/",        "tags": ["Backtracking", "DFS"]},
    ...
    "Bit Manipulation": {
        ...
        "problems": [
            ...
            {"id": "268", "name": "Missing Number",     "difficulty": "Easy",   "time_estimate_mins": 15, "leetcode_link": "https://leetcode.com/problems/missing-number/",     "tags": ["Bit Manipulation", "Math"]},
        ],
    },
}

# Time plan configs — both keys used by dsa_tutor_agent and generate_daily_schedule
TIME_PLAN_CONFIGS = {
    "3_months": {
        "total_days": 90,
        "total_weeks": 13,
        "problems_per_week": 14,
...
def get_topic_problems(topic_name: str):
    return DSA_TOPICS_MAP.get(topic_name, {}).get("problems", [])


def get_topic_info(topic_name: str):
    if topic_name not in DSA_TOPICS_MAP:
        return None
    info = {k: v for k, v in DSA_TOPICS_MAP[topic_name].items() if k != "problems"}
    info["problem_count"] = len(DSA_TOPICS_MAP[topic_name]["problems"])
    return info


def count_total_problems():
    return sum(len(t["problems"]) for t in DSA_TOPICS_MAP.values())


def _problems_by_difficulty(difficulty: str):
    result = []
    for topic_name, topic_data in DSA_TOPICS_MAP.items():
        for p in topic_data["problems"]:
            if p["difficulty"] == difficulty:
                result.append({"topic": topic_name, **p})
    return result


def get_easy_problems():
    return _problems_by_difficulty("Easy")


def get_medium_problems():
    return _problems_by_difficulty("Medium")


def get_hard_problems():
    return _problems_by_difficulty("Hard")


def generate_daily_schedule(months: int):
    """
    Generate a daily learning schedule: 1 easy + 1 medium per day.
    Problems cycle if total days exceed unique problem count.
    """
    time_key = f"{months}_months"
    if time_key not in TIME_PLAN_CONFIGS:
        return None

    total_days = TIME_PLAN_CONFIGS[time_key]["total_days"]
    easy_problems   = get_easy_problems()
    medium_problems = get_medium_problems()

    if not easy_problems or not medium_problems:
        return None

    daily_schedule = []
    for day in range(1, total_days + 1):
        easy_prob  = easy_problems[(day - 1) % len(easy_problems)]
        medium_prob = medium_problems[(day - 1) % len(medium_problems)]
        daily_schedule.append({
            "day": day,
            "easy_problem":  easy_prob,
            "easy_topic":    easy_prob["topic"],
            "medium_problem": medium_prob,
            "medium_topic":  medium_prob["topic"],
